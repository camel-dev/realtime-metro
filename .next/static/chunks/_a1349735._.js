    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("aside", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("ul", {
                ...
                children: subwayLines.map((line)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("li", {
                        onClick: ()=>{
...
"[project]/components/SubwayMap.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SubwayMap({ selectedLine }) {
    ...
    const pinchStart = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubwayMap.useEffect": ()=>{
            ...
            return ({
                "SubwayMap.useEffect": ()=>window.removeEventListener("resize", handle)
            })["SubwayMap.useEffect"];
        }
    }["SubwayMap.useEffect"], [
        selectedLine
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubwayMap.useEffect": ()=>{
            ...
            const fetchTrains = {
                "SubwayMap.useEffect.fetchTrains": async ()=>{
                    try {
                        ...
                        const data = rows.map({
                            "SubwayMap.useEffect.fetchTrains.data": (row)=>({
                        ...
                        }["SubwayMap.useEffect.fetchTrains.data"]);
                        // 고유 값 맵 만들기
                        const uniqueDataMap = new Map();
                        // Map에 항목 추가 및 중복 제거
                        data.forEach({
                            "SubwayMap.useEffect.fetchTrains": (item)=>{
                                // 중복 확인을 위한 키 조합
                        ...
                        }["SubwayMap.useEffect.fetchTrains"]);
                        // 중복 제거된 데이터 배열 생성
            ...
            return ({
                "SubwayMap.useEffect": ()=>clearInterval(interval)
            })["SubwayMap.useEffect"];
        }
    }["SubwayMap.useEffect"], [
        selectedLine
    ...
    const [stationCoords, setStationCoords] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // 2. 1호선일 때만 JSON에서 좌표 불러오기
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SubwayMap.useEffect": ()=>{
            if (selectedLine === "1") {
                fetch("/realtime-metro/line1_all_station_coords_updated.json").then({
                    "SubwayMap.useEffect": (res)=>res.json()
                }["SubwayMap.useEffect"]).then(setStationCoords);
            } else {
                setStationCoords([]);
            }
        }
...
_s(SubwayMap, "B15DTbF3GDChELcN0pMSiROT4JA=");
_c = SubwayMap;
var _c;
__turbopack_context__.k.register(_c, "SubwayMap");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SubwayMap$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/SubwayMap.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function RootLayout({ children }) {
    ...
    const [selectedLine, setSelectedLine] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("1"); // 여기 "2" → "1"로 변경
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("body", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$SubwayMap$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(RootLayout, "4q3a8I8wXfY4yYCFDIJrL0gk0N0=");
_c = RootLayout;
var _c;
...
//# sourceMappingURL=_a1349735._.js.map